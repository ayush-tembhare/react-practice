  ...
  return (
    <div className='App'>
      {jobOpenings.map(function(elem,idx){
        return(
            <Card key={idx} companyName={elem.companyName} datePosted={elem.datePosted} post={elem.post} tag1={elem.tag1} brandLogo={elem.brandLogo} pay={elem.pay} tag2={elem.tag2} />
        )
}) }
    </div>
  )
